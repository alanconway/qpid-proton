...
struct EqualsMatcher : CStringMatcherBase {
    EqualsMatcher(const char *comparator) : CStringMatcherBase("equals", comparator) {}
    bool match(const char *source) const CATCH_OVERRIDE {
        // match if both null or both non-null and equal
        return source == m_comparator || (source && m_comparator && std::string(source) == std::string(m_comparator));
    }
};

struct ContainsMatcher : CStringMatcherBase {
    ContainsMatcher(const char *comparator) : CStringMatcherBase("contains", comparator) {}
    bool match(const char *source) const CATCH_OVERRIDE {
...
struct StartsWithMatcher : CStringMatcherBase {
    StartsWithMatcher(const char *comparator) : CStringMatcherBase("starts with", comparator) {}
    bool match(const char *source) const CATCH_OVERRIDE {
...
struct EndsWithMatcher : CStringMatcherBase {
    EndsWithMatcher(const char *comparator) : CStringMatcherBase("ends with", comparator) {}
    bool match(const char *source) const CATCH_OVERRIDE {
...
CString::EqualsMatcher Equals(const char * str) { return CString::EqualsMatcher(str); }
CString::ContainsMatcher Contains(const char * str) { return CString::ContainsMatcher(str); }
CString::StartsWithMatcher StartsWith(const char * str) { return CString::StartsWithMatcher(str); }
CString::EndsWithMatcher EndsWith(const char * str) { return CString::EndsWithMatcher(str); }
